...
Example:
    python test_analytics.py handstand_video.mp4
    python test_analytics.py handstand_video.mp4 handstand
"""
...
def main():
    if len(sys.argv) < 2:
        ...
        print("\nExample:")
        print("  python test_analytics.py handstand_video.mp4")
        print("  python test_analytics.py handstand_video.mp4 handstand")
        sys.exit(1)
    ...
    # Get exercise name (default to 'handstand')
    exercise_name = sys.argv[2] if len(sys.argv) > 2 else 'handstand'
    
    # Create output directory (go back to Backend dir for output)

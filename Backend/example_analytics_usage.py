...
analytics = PoseAnalyticsService(config=config.get('pose_criteria', {}))

# Example: Create a sample handstand pose (13 joints x 3 coordinates)
# This is a simplified example - in reality, this comes from MediaPipe
sample_handstand_pose = np.array([
    [0.0, 0.5, 0.0],   # 0: nose
...
result = analytics.analyze_handstand(sample_handstand_pose)
...
for i, error in enumerate(result['errors'], 1):
    ...
    print(f"     Measurement: {error['measurement']}")
